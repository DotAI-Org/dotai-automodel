...
The public dealer and outlet scale sets the regional order of magnitude.

## Step 2: Define the manager data boundary
The manager sees South India with dealer billing, outlet panel, field team and loyalty program data.

## Step 3: Choose files from first principles
Files follow the manager's joins: dealer/outlet master plus invoice lines, credit, field, loyalty, and claims.
