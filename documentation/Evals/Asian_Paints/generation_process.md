...
The public retail touchpoint and billed dealer counts define a dealer-led network with service overlays.

## Step 2: Define the manager data boundary
The manager sees dealer sales, machine usage, contractor behavior, complaints and lead movement.

## Step 3: Choose files from first principles
Files follow sales loss causes: lower billing, tinting usage drop, contractor inactivity, credit, complaints, and project lead leakage.
